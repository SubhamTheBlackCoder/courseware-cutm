  ...
  return (<>
    <div>
     <div className="topRight">
        <Link to="/teacher/killersmile/users" className="adminButton">Admin</Link>
      </div>
      {savedProfile && (
          ...
          <div className="containerStyle">
            <div className="leftSectionStyle">
              <div className="logoContainerStyle">
                <img src="../images/teacher/rashmi.png" alt="Logo" className="logoStyle" />
              </div>
...
export default TeacherFirstPageRashmi;
