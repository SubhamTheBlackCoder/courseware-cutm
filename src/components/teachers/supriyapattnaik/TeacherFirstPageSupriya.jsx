  ...
  return (<>
    <div>
     <div className="topRight">
        <Link to="/teacher/intelli/users" className="adminButton">Admin</Link>
      </div>
      {savedProfile && (
          ...
          <div className="containerStyle">
            <div className="leftSectionStyle">
              <div className="logoContainerStyle">
                <img src="https://faculty.cutm.ac.in/public/images/1599715559.jpg" alt="Logo" className="logoStyle" />
              </div>
...
export default TeacherFirstPageSupriya;
