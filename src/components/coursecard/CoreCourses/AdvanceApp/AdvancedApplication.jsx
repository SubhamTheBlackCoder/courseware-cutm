  ...
  return (
    <>
      <div className="topRight">
        <Link
          to="/course/core-course/Advanced-Application/description/users"
      ...
      <nav className="Navdb">
        <h1 className="page-heading">Advanced Application</h1>
        ...
        <ul className="Navdb-links">
          <li>
            <Link to="/course/core-course/Advanced-Application/description">
              Description
            </Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Application">Teachers</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Application">Attendees</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Application">Comments</Link>
          </li>
          <li>
