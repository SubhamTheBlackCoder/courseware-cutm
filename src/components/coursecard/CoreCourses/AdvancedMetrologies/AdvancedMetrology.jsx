  ...
  return (
    <>
      <div className="topRight">
        <Link
          to="/course/core-course/Advanced-Metrology/description/users"
      ...
      <nav className="Navdb">
        <h1 className="page-heading">Advanced Metrology</h1>
        ...
        <ul className="Navdb-links">
          <li>
            <Link to="/course/core-course/Advanced-Metrology/description">
              Description
            </Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Metrology">Teachers</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Metrology">Attendees</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Metrology">Comments</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Metrology">Reviews</Link>
          </li>
        </ul>
        <Outlet />
      </nav>
