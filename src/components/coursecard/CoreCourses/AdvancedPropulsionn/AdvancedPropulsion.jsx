...
function AdvancedPropulsion() {
  return (
    <>
      <div className="topRight">
        <Link
          to="/course/core-course/Advanced-Propulsionn/description/users"
      ...
      <nav className="Navdb">
        <h1 className="page-heading">Advanced Propulsion</h1>
        ...
        <ul className="Navdb-links">
          <li>
            <Link to="/course/core-course/Advanced-Propulsionn/description">
              Description
            </Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Propulsionn">Teachers</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Propulsionn">Attendees</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Propulsionn">Comments</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Propulsionn">Reviews</Link>
          </li>
        </ul>
        <Outlet />
      </nav>
...
export default AdvancedPropulsion;
