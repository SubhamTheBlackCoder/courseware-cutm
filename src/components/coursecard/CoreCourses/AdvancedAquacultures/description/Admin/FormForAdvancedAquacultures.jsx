...
const FormForAdvancedAquacultures = () => {
  ...
  const handleLogin = () => {
    ...
    if (user) {
      ...
      history('/course/core-course/Advanced-Aquaculture/description/users/detail-form');
    } else {
...
export default FormForAdvancedAquacultures;
