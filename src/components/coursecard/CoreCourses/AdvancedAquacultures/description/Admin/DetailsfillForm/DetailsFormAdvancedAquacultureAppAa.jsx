...
const DetailsFormAdvancedAquacultureAppAa = () => {
  ...
  const updateProfile = (course) => {
    axios
      ...
      .then((response) => {
        ...
        navigate(`/course/core-course/Advanced-Aquaculture/description`, {
...
export default DetailsFormAdvancedAquacultureAppAa;
