...
function AdvancedAquaculture() {
  return (
    <>
      <div className="topRight">
        <Link
          to="/course/core-course/Advanced-Aquaculture/description/users"
      ...
      <nav className="Navdb">
        <h1 className="page-heading">Advanced Aquaculture</h1>
        ...
        <ul className="Navdb-links">
          <li>
            <Link to="/course/core-course/Advanced-Aquaculture/description">
              Description
            </Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Aquaculture">Teachers</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Aquaculture">Attendees</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Aquaculture">Comments</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Aquaculture">Reviews</Link>
          </li>
        </ul>
        <Outlet />
      </nav>
...
export default AdvancedAquaculture;
