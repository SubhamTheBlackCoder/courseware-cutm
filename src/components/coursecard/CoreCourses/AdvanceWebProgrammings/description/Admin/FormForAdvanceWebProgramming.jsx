...
const FormForAdvanceWebProgramming = () => {
  ...
  const handleLogin = () => {
    ...
    if (user) {
      ...
      history('/course/core-course/Advance-web-Programming/description/users/detail-form');
    } else {
...
export default FormForAdvanceWebProgramming;
