  ...
  return (
    <>
      <div className="topRight">
        <Link
          to="/course/core-course/Advanced-Analysis/description/users"
      ...
      <nav className="Navdb">
        <h1 className="page-heading">Advanced Analysis</h1>
        ...
        <ul className="Navdb-links">
          <li>
            <Link to="/course/core-course/Advanced-Analysis/description">
              Description
            </Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Analysis">Teachers</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Analysis">Attendees</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Analysis">Comments</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Analysis">Reviews</Link>
          </li>
        </ul>
        <Outlet />
      </nav>
