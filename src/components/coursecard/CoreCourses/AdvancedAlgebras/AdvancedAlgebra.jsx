...
function AdvancedAlgebra() {
  return (
    <>
      <div className="topRight">
        <Link
          to="/course/core-course/Advanced-algebra/description/users"
      ...
      <nav className="Navdb">
        <h1 className="page-heading">Advanced Algebra</h1>
        ...
        <ul className="Navdb-links">
          <li>
            <Link to="/course/core-course/Advanced-algebra/description">
              Description
            </Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-algebra">Teachers</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-algebra">Attendees</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-algebra">Comments</Link>
          </li>
          <li>
            <Link to="/course/core-course/Advanced-Application">Reviews</Link>
          </li>
        </ul>
        <Outlet />
      </nav>
